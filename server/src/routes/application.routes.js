import { getMyApplication, acceptApplication, rejectApplication, withdrawApplication } from "../controller/application.controller.js";
...
router.delete("/:applicationId", Authenticator, authorize("CANDIDATE"), withdrawApplication);
